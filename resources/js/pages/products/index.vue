        ...
        >
            ...
            <div class="w-10/12 justify-center">
                ...
                <Table>
                    ...
                    <TableBody>
                        <TableRow
                            v-for="product in productProps.products.data"
                            :key="product.id"
                        >
                            ...
                            <TableCell class="text-right">
                                <Link
                                    :href="productsRoute.edit(product.id).url"
                                >
                                    <Button variant="outline">Edit</Button>
                                </Link>
                                <Link
                                    :href="
                                        productsRoute.destroy(product.id).url
                                    "
                                    method="delete"
                                    class="ml-2"
                                    @click="confirmDelete"
                ...
                <div class="mt-4 flex items-center justify-between">
                    <p class="text-sm text-muted-foreground">
                        Página {{ productProps.products.current_page }} de
                        {{ productProps.products.last_page }}
                    </p>
                    <div class="flex gap-2">
                        <Link
                            v-if="productProps.products.prev_page_url"
                            :href="productProps.products.prev_page_url"
                        >
                            <Button variant="outline">Previous</Button>
                        </Link>
                        <Link
                            v-if="productProps.products.next_page_url"
