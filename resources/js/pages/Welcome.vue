...
<template>
    ...
    <div
        class="min-h-screen bg-[#f8f8f6] text-[#171717] dark:bg-[#090909] dark:text-[#f2f2f2]"
    >
        <div
            class="mx-auto flex min-h-screen max-w-6xl flex-col px-6 py-6 lg:px-8 lg:py-8"
        >
            ...
            <main
                class="flex flex-1 flex-col justify-center gap-10 py-10 lg:gap-16 lg:py-16"
            >
                <section
                    class="relative mt-10 grid items-start gap-10 lg:mt-14 lg:grid-cols-[1fr_1.15fr]"
                >
                    <div
                    ...
                    <div
                        class="opacity-100 transition-all duration-700 starting:translate-y-2 starting:opacity-0"
                    >
                        <p
                        ...
                        <h1
                            class="mt-4 text-4xl leading-tight font-semibold tracking-tight text-balance lg:text-5xl"
                        >
                            Run your inventory operations with a clear,
                            actionable platform.
                        </h1>
                        <p
                            class="mt-4 max-w-xl text-base leading-7 text-pretty text-black/70 dark:text-white/70"
                        >
                            Track inbound and outbound stock, define per-item
                            minimums, and make decisions from live KPIs.
                    ...
                    <div
                        class="opacity-100 transition-all delay-100 duration-700 lg:pt-14 starting:translate-y-2 starting:opacity-0"
                    >
                        <div
                ...
                <section class="mt-16 grid gap-6 lg:grid-cols-3">
                    ...
                    >
                        ...
                        <ul
                            class="mt-3 space-y-2 text-sm text-black/70 dark:text-white/70"
                        >
                ...
                <section id="demo" class="mt-16">
                    <h2 class="text-2xl font-semibold tracking-tight">
                        Search products, Manage inventory, Not install needed
                    </h2>
                    <p
                        class="mt-2 max-w-2xl text-sm text-black/70 dark:text-white/70"
                    >
                    ...
                    <div class="mt-6">
                        ...
                        >
                            ...
                            />
                            <figcaption
                                class="px-4 py-3 text-sm text-black/70 dark:text-white/70"
                            >
                                {{ currentGifCaption }}
                            </figcaption>
                        </figure>
                        ...
                        >
                            <div>
                                <h3 class="text-base font-semibold">
                                    Demo access and full license
                                </h3>
                                <p
                                    class="mt-1 text-sm text-black/70 dark:text-white/70"
                                >
                                    This Demo data resets periodically. Full
                                    persistent version is sold as a single-tier
                                    license. Chages can be apply on demand.
                                </p>
                            </div>
