...
<template>
    <form class="space-y-4 rounded-lg border p-4" @submit.prevent="submit">
        <div class="space-y-2">
            ...
            <p v-if="form.errors.product_id" class="text-sm text-red-500">
        ...
        <div class="space-y-2">
            ...
            <p v-if="form.errors.provider_id" class="text-sm text-red-500">
        ...
        <div class="space-y-2">
            ...
            />
            <p v-if="form.errors.remarks" class="text-sm text-red-500">
                {{ form.errors.remarks }}
            </p>
        </div>
