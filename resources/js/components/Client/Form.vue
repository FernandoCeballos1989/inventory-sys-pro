    ...
    <form class="space-y-4 rounded-lg border p-4" @submit.prevent="submit">
        ...
        <div class="space-y-2">
            ...
            <Input
                ...
                type="text"
                placeholder="Fiscal code of the client"
            />
            <p v-if="form.errors.fiscal_code" class="text-sm text-red-500">
                {{ form.errors.fiscal_code }}
            </p>
        </div>
        <div class="space-y-2">
        ...
        <div class="space-y-2">
            ...
            />
            <p v-if="form.errors.send_address" class="text-sm text-red-500">
                {{ form.errors.send_address }}
            </p>
        </div>
